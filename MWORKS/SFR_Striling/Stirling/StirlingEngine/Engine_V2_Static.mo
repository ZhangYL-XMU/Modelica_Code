within SFR_Striling.Stirling.StirlingEngine;
model Engine_V2_Static
...
grid={2,2})));
  replaceable package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium;
  ...
  MechanicalGas.Stirling_Static stirling(cylinderInclinationAngle(displayUnit="deg"),crankAngleOffset(displayUnit="deg"),cylinderInclinationAngle1(displayUnit="deg"),crankAngleOffset1(displayUnit="deg")) 
    annotation (Placement(transformation(origin={-62,-8.2},
extent={{-52,-26},{52,26}})));
  MechanicalGas.Stirling_Static stirling1(cylinderInclinationAngle(displayUnit="deg"),crankAngleOffset(displayUnit="deg"),cylinderInclinationAngle1(displayUnit="deg"),crankAngleOffset1(displayUnit="deg")) 
...
extent={{-10,-10},{10,10}})));
  Modelica.Fluid.Interfaces.FluidPort_b cold(h_outflow = hB) 
