within SFR_Striling.Stirling.DoubleActing.Gas_Dynamic;
...
extent={{-30,-30},{30,30}})));
  ...
  SFR_Striling.Stirling.DoubleActing.DA_Cylinder cyl1(crankAngleOffset = 0) 
    annotation(Placement(transformation(origin={92,-20},
extent={{-60,-80},{60,80}})));
  SFR_Striling.Stirling.DoubleActing.DA_Cylinder cyl2(crankAngleOffset = -Modelica.Constants.pi / 2) 
    annotation(Placement(transformation(origin={226,-20},
extent={{-60,-80},{60,80}})));
  SFR_Striling.Stirling.DoubleActing.DA_Cylinder cyl3(crankAngleOffset = -Modelica.Constants.pi) 
    annotation(Placement(transformation(origin={386,-20},
extent={{-60,-80},{60,80}})));
  SFR_Striling.Stirling.DoubleActing.DA_Cylinder cyl4(crankAngleOffset = -3 * Modelica.Constants.pi / 2) 
