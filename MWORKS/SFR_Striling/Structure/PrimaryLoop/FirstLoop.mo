...
extent={{-10,-10},{10,10}})));
    SFR_Striling.Fluid.Pipes.pipe pipe1(redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, N=5, height_ab=-10, initFromEnthalpy=true, h_start=519165, n_pipe=30, m_flow_start=1.34) 
      annotation (Placement(transformation(origin={-3,-6},
extent={{-10,-10},{10,10}},
rotation=90)));
    SFR_Striling.Fluid.Pipes.pipe pipe2(redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, N=5, height_ab=-10, initFromEnthalpy=true, h_start=519165, n_pipe=180, momentumDynamics=Modelica.Fluid.Types.Dynamics.SteadyState) 
      annotation (Placement(transformation(origin={77,-6},
extent={{-10,-10},{10,10}},
rotation=90)));
    Fluid.Pipes.pipe pipe_static1(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, initFromEnthalpy=true, h_start=519165, wallHeatTransfer=false, momentumDynamics=Modelica.Fluid.Types.Dynamics.SteadyState) 
      annotation (Placement(transformation(origin={123,92},
extent={{-10,-10},{10,10}})));
    SFR_Striling.Fluid.Pipes.pipe pipe_static2(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, initFromEnthalpy=true, h_start=519165, wallHeatTransfer=false, momentumDynamics=Modelica.Fluid.Types.Dynamics.SteadyState) 
      annotation (Placement(transformation(origin={115,-112},
extent={{10,-10},{-10,10}})));
    SFR_Striling.Fluid.Vessels.MixingVolume volume(nPorts_a=2, nPorts_b=1, V=10, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
      annotation (Placement(transformation(origin={31,60},
extent={{-10,-10},{10,10}},
rotation=90)));
    SFR_Striling.Fluid.Vessels.MixingVolume volume1(redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, nPorts_a=1, nPorts_b=2, V=10) 
      annotation (Placement(transformation(origin={31,-82},
extent={{-10,-10},{10,10}},
rotation=90)));
    SFR_Striling.Nuclear.PointKinetics pointKinetics(Teffref_fuel(displayUnit="K"), Teffref_coolant(displayUnit="degC")=785.15) 
...
extent={{-10,-10},{10,10}})));
    SFR_Striling.Fluid.Machines.Pump_SimpleMassFlow pump1(m_flow_nominal=280.6, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
      annotation (Placement(transformation(origin={178.011,-114.009},
extent={{10,-10},{-10,10}})));
    SFR_Striling.Fluid.Vessels.ExpansionTank expansionTank(redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, A=1, V0=0.001, level_start=1, h_start=469125, p_start=100000.0) 
...
extent={{10,-10},{-10,10}})));
    SFR_Striling.Thermal.HeatExchange.HE1 hE1_1(shell(momentumDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)) 
