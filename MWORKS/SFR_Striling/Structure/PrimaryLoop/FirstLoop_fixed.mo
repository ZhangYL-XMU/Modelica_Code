model FirstLoop_fixed
  ...
  TYThermoFluidSys.Sensors.SensorT TSensor2(redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
    annotation (Placement(transformation(origin={31,112},
    extent={{-10,-10},{10,10}})));
  SFR_Striling.Fluid.Pipes.pipe pipe_static1(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, L_total=10, Dh=0.30, initFromEnthalpy=true, h_start=656775 "热段550℃", wallHeatTransfer=false, momentumDynamics=Modelica.Fluid.Types.Dynamics.SteadyState) 
    annotation (Placement(transformation(origin={123,92},
    extent={{-10,-10},{10,10}})));
  SFR_Striling.Fluid.Pipes.pipe pipe_static2(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, L_total=10, Dh=0.30, initFromEnthalpy=true, h_start=519165 "冷段440℃", wallHeatTransfer=false, momentumDynamics=Modelica.Fluid.Types.Dynamics.SteadyState) 
    annotation (Placement(transformation(origin={104,-132},
extent={{10,-10},{-10,10}})));
  SFR_Striling.Fluid.Vessels.MixingVolume volume(nPorts_a=3, nPorts_b=1, V=10, h_start=656775 "上腔室550℃", redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
    annotation (Placement(transformation(origin={6,70},
extent={{-10,-10},{10,10}},
rotation=90)));
  SFR_Striling.Fluid.Vessels.MixingVolume volume1(redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, nPorts_a=1, nPorts_b=3, V=10, h_start=519165 "下腔室440℃") 
    annotation (Placement(transformation(origin={6,-126},
extent={{-10,-10},{10,10}},
rotation=90)));
  SFR_Striling.Nuclear.PointKinetics pointKinetics(Teffref_fuel(displayUnit="K"), Teffref_coolant(displayUnit="degC")=768.15 "参考=额定堆芯平均温度(440+550)/2=495℃=768.15K(尹凯论文口径); 初始冷却剂反馈=0, 功率不跌落") 
...
extent={{10,-10},{-10,10}})));
  SFR_Striling.Fluid.Vessels.ExpansionTank expansionTank(redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, A=1, V0=0.001, level_start=1, h_start=656775 "热段550℃", p_start=100000.0) 
    annotation (Placement(transformation(origin={154,154},
extent={{-10,-10},{10,10}})));
  SFR_Striling.Fluid.Vessels.SpecifiedResistance resistance_toBoundary(redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, R=0.1) 
    annotation (Placement(transformation(origin={172,118},
extent={{-10,-10},{10,10}})));
  SFR_Striling.Thermal.HeatExchange.HE1 hE1_1(shell(momentumDynamics=Modelica.Fluid.Types.Dynamics.SteadyState),N=10) 
