...
rotation=90)));
  Modelica.Blocks.Sources.Ramp ramp(offset=280.6, startTime=1200, duration=60, height=-84.18) 
    annotation (Placement(transformation(origin={-20,-102},
extent={{-10,-10},{10,10}})));
  Modelica.Blocks.Sources.Ramp ramp1(offset=308.4, startTime=1200, duration=60, height=-92.52) 
    annotation (Placement(transformation(origin={226,82},
extent={{10,-10},{-10,10}})));
  equation
...
color={0,127,255}));
  ...
  annotation(Line(origin={5,-114},
points={{-14,12},{0.74165,12},{0.74165,-12.473}},
color={0,0,127}));
  connect(ramp1.y, pump2.in_m_flow) 
  annotation(Line(origin={202,69},
  points={{13,13},{-14,13},{-14,-13.7}},
  color={0,0,127}));
  end flowDown;