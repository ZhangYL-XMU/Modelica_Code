...
extent={{-10,-10},{10,10}},
rotation=90)));
  Modelica.Blocks.Sources.Ramp ramp(startTime=1200,duration=160,height=0.00171) 
    annotation (Placement(transformation(origin={-386,102},
extent={{-10,-10},{10,10}})));
  equation
...
color={0,127,255}));
  ...
  annotation(Line(origin={-349,83},
points={{-26,19},{3,19},{3,-1},{22.237,-1},{22.237,-17.3632},{25.992,-17.3632}},
color={0,0,127}));
  end CR;