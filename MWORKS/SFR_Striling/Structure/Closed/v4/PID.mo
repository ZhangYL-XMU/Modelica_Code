...
extent={{-10,-10},{10,10}},
rotation=90)));
  TYThermoFluidSys.Blocks.Ramp ramp(offset=40e6, height=4e6, duration=60, startTime=1200) 
    annotation (Placement(transformation(origin={-562.009,98},
extent={{-10,-10},{10,10}})));
...
color={0,0,127}));
  ...
  annotation(Line(origin={-461.991,99.5987},
