...
rotation=90)));
  Modelica.Blocks.Sources.RealExpression realExpression2(y=(Engine_pipe.T[1] + Engine_pipe.T[2] + Engine_pipe.T[3] + Engine_pipe.T[4]) / 4) 
    annotation (Placement(transformation(origin={206,-112.446},
extent={{-10,-10},{10,10}})));
  v4.ROM.ROM_Basis rOM_Basis 
    annotation (Placement(transformation(origin={258,-112.446},
extent={{-10,-10},{10,10}})));
  equation
...
color={0,127,255}));
  connect(rOM_Basis.ROM_IN[1], realExpression2.y) 
  annotation(Line(origin={233,-112},
  points={{15.2,0.293931},{-16,0.293931},{-16,-0.446}},
  color={0,0,127}));
  connect(rOM_Basis.ROM_OUT[2], gain1.u) 
  annotation(Line(origin={288,-101},
  points={{-20,-10.7061},{20,-10.7061},{20,10.371}},
  color={0,0,127}));
  end ROM;