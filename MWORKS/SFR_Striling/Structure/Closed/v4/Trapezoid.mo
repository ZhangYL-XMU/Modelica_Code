...
extent={{-10,-10},{10,10}})));
  Modelica.Blocks.Sources.Trapezoid trapezoid(offset=40e6, startTime=800, amplitude=4e6, rising=120, width=300, falling=120, period=720) 
    annotation (Placement(transformation(origin={-560,98},
extent={{-10,-10},{10,10}})));
  equation
...
color={0,0,127}));
  connect(gain_uS.u, trapezoid.y) 
  annotation(Line(origin={-539,98},
  points={{10.991,0},{-10,0}},
  color={0,0,127}));
  end Trapezoid;