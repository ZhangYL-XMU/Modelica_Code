...
extent={{-10,-10},{10,10}})));
    TRANSFORM.Fluid.Machines.Pump_SimpleMassFlow pump1(m_flow_nominal=280.6, redeclare package Medium = Media.Sodium.ConstantPropertyLiquidSodium, use_input=true) 
...
extent={{-10,-10},{10,10}})));
    Fluid.Vessels.SpecifiedResistance resistance_inner(redeclare package Medium = Media.Sodium.ConstantPropertyLiquidSodium, R=20.6 "内堆芯 62.7 kg/s(标定同步)") 
      annotation (Placement(transformation(origin={-183.964,-62},
extent={{-10,-10},{10,10}},
rotation=90)));
    Fluid.Vessels.SpecifiedResistance resistance_outer(redeclare package Medium = Media.Sodium.ConstantPropertyLiquidSodium, R=4.30 "外堆芯 217.4 kg/s(标定同步)") 
      annotation (Placement(transformation(origin={-97.9819,-62},
extent={{-10,-10},{10,10}},
rotation=90)));
    Fluid.Vessels.SpecifiedResistance resistance_shield(redeclare package Medium = Media.Sodium.ConstantPropertyLiquidSodium, R=6280 "屏蔽+反射等温流道 0.5 kg/s(标定同步)") 
      annotation (Placement(transformation(origin={-25.9819,-62},
extent={{-10,-10},{10,10}},
rotation=90)));
    Fluid.Pipes.pipe outerCore_out(redeclare package Medium = Media.Sodium.ConstantPropertyLiquidSodium, N=2, n_pipe=114, L_total=0.15, Dh=0.0415, height_ab=-0.15, initFromEnthalpy=true, h_start=656775, wallHeatTransfer=false, momentumDynamics=Modelica.Fluid.Types.Dynamics.DynamicFreeInitial, m_flow_start=1.907 "单管217.4/114(标定同步)") 
      annotation (Placement(transformation(origin={-97.9819,24},
extent={{-10,-10},{10,10}},
rotation=90)));
    Fluid.Pipes.pipe outerCore(redeclare package Medium = Media.Sodium.ConstantPropertyLiquidSodium, N=5, n_pipe=114, L_total=1.1, L_heat=1.1, Dh=0.0415, height_ab=-1.1, initFromEnthalpy=true, h_start=519165, wallHeatTransfer=true, momentumDynamics=Modelica.Fluid.Types.Dynamics.DynamicFreeInitial, m_flow_start=1.907 "单管217.4/114(标定同步)", redeclare model HeatTransfer = Fluid.Pipes.BaseClasses.HeatTransfer.core) 
      annotation (Placement(transformation(origin={-97.9819,0},
extent={{-10,-10},{10,10}},
rotation=90)));
    Fluid.Pipes.pipe outerCore_in(redeclare package Medium = Media.Sodium.ConstantPropertyLiquidSodium, N=2, n_pipe=114, L_total=0.25, Dh=0.0415, height_ab=-0.25, initFromEnthalpy=true, h_start=519165, wallHeatTransfer=false, momentumDynamics=Modelica.Fluid.Types.Dynamics.DynamicFreeInitial, m_flow_start=1.907 "单管217.4/114(标定同步)") 
      annotation (Placement(transformation(origin={-97.9819,-24},
extent={{-10,-10},{10,10}},
rotation=90)));
    Fluid.Pipes.pipe innerCore_out(redeclare package Medium = Media.Sodium.ConstantPropertyLiquidSodium, N=2, n_pipe=37, L_total=0.15, Dh=0.0415, height_ab=-0.15, initFromEnthalpy=true, h_start=656775, wallHeatTransfer=false, momentumDynamics=Modelica.Fluid.Types.Dynamics.DynamicFreeInitial, m_flow_start=1.695 "单管62.7/37(标定同步)") 
      annotation (Placement(transformation(origin={-183.982,24},
extent={{-10,-10},{10,10}},
rotation=90)));
    Fluid.Pipes.pipe innerCore(redeclare package Medium = Media.Sodium.ConstantPropertyLiquidSodium, N=5, n_pipe=37, L_total=1.1, L_heat=1.1, Dh=0.0415, height_ab=-1.1, initFromEnthalpy=true, h_start=519165, wallHeatTransfer=true, momentumDynamics=Modelica.Fluid.Types.Dynamics.DynamicFreeInitial, m_flow_start=1.695 "单管62.7/37(标定同步)", redeclare model HeatTransfer = Fluid.Pipes.BaseClasses.HeatTransfer.core) 
      annotation (Placement(transformation(origin={-183.982,0},
extent={{-10,-10},{10,10}},
rotation=90)));
    Fluid.Pipes.pipe innerCore_in(redeclare package Medium = Media.Sodium.ConstantPropertyLiquidSodium, N=2, n_pipe=37, L_total=0.25, Dh=0.0415, height_ab=-0.25, initFromEnthalpy=true, h_start=519165, wallHeatTransfer=false, momentumDynamics=Modelica.Fluid.Types.Dynamics.DynamicFreeInitial, m_flow_start=1.695 "单管62.7/37(标定同步)") 
      annotation (Placement(transformation(origin={-183.982,-24},
extent={{-10,-10},{10,10}},
rotation=90)));
