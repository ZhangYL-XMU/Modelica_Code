...
extent={{-10,-10},{10,10}})));
  Modelica.Blocks.Sources.Sine sine(offset=40e6, amplitude=4e6, startTime=1000, f=1 / 500) 
    annotation (Placement(transformation(origin={-566,156},
extent={{-10,-10},{10,10}})));
  equation
...
color={0,0,127}));
  ...
  annotation(Line(origin={-542,156},
  points={{12,0},{-13,0}},
  color={0,0,127}));
  end Sine;