within SFR_Striling.Media.Interfaces;
  partial package PartialSimpleMedium
    ...
    extends Media.Interfaces.PartialPureSubstance(final ThermoStates=Modelica.Media.Interfaces.Choices.IndependentVariables.pT,
        final singleState=true);

    constant Modelica.Media.Interfaces.Types.SpecificHeatCapacity cp_const
      "Constant specific heat capacity at constant pressure";
    constant Modelica.Media.Interfaces.Types.SpecificHeatCapacity cv_const
      "Constant specific heat capacity at constant volume";
    constant Modelica.Media.Interfaces.Types.Density d_const "Constant density";
    constant Modelica.Media.Interfaces.Types.DynamicViscosity eta_const "Constant dynamic viscosity";
    constant Modelica.Media.Interfaces.Types.ThermalConductivity lambda_const "Constant thermal conductivity";
    constant Modelica.Media.Interfaces.Types.VelocityOfSound a_const "Constant velocity of sound";
    constant Modelica.Media.Interfaces.Types.Temperature T_min "Minimum temperature valid for medium model";
    constant Modelica.Media.Interfaces.Types.Temperature T_max "Maximum temperature valid for medium model";
    constant Modelica.Media.Interfaces.Types.Temperature T0=reference_T "Zero enthalpy temperature";
    constant Modelica.Media.Interfaces.Types.MolarMass MM_const "Molar mass";

    constant Modelica.Media.Interfaces.PartialMedium.FluidConstants[nS] fluidConstants "Fluid constants";

    redeclare record extends ThermodynamicState "Thermodynamic state"
      Modelica.Media.Interfaces.Types.AbsolutePressure p "Absolute pressure of medium";
...
Note that the (small) influence of the pressure term p/d is neglected.
    ...
    redeclare function specificEnthalpy_pTX
      ...
      input Modelica.Media.Interfaces.Types.AbsolutePressure p "Pressure";
      input Modelica.Media.Interfaces.Types.Temperature T "Temperature";
      input Modelica.Media.Interfaces.Types.MassFraction X[nX] "Mass fractions";
