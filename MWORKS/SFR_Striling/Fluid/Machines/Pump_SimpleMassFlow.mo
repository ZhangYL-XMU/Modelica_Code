within SFR_Striling.Fluid.Machines;
  model Pump_SimpleMassFlow "Prescribes mass flow rate across the component"
    ...
    parameter Modelica.Units.SI.MassFlowRate m_flow_nominal=0 "Nominal mass flowrate" annotation(Dialog(enable=not use_input));
