within SFR_Striling.Fluid.Vessels.Test;
  model test_volume
    annotation(__MWORKS(version="26.1.3"),Diagram(coordinateSystem(extent={{-100,-100},{100,100}},
grid={2,2})));
    MixingVolume volume(redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, nPorts_a=2, nPorts_b=1, V=1) 
      annotation (Placement(transformation(origin={-2,6.66134e-16},
extent={{-10,-10},{10,10}})));
    Pipes.pipe_static pipe_static1(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
      annotation (Placement(transformation(origin={-40,16},
extent={{-10,-10},{10,10}})));
    Pipes.pipe_static pipe_static2(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
      annotation (Placement(transformation(origin={44,0},
extent={{-10,-10},{10,10}})));
    Pipes.pipe_static pipe_static3(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
      annotation (Placement(transformation(origin={-40,-14},
extent={{-10,-10},{10,10}})));
    Modelica.Fluid.Sources.MassFlowSource_T boundary(nPorts=1, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, m_flow=10) 
      annotation (Placement(transformation(origin={-86,16},
extent={{-10,-10},{10,10}})));
    Modelica.Fluid.Sources.MassFlowSource_T boundary1(nPorts=1, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, m_flow=10) 
      annotation (Placement(transformation(origin={-86,-14.0181},
extent={{-10,-10},{10,10}})));
    Modelica.Fluid.Sources.Boundary_ph boundary2(nPorts=1, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, p=1e5) 
      annotation (Placement(transformation(origin={90,0},
extent={{10,-10},{-10,10}})));
    MixingVolume volume1(redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, nPorts_a=1, nPorts_b=2, V=1) 
      annotation (Placement(transformation(origin={-6,-70},
extent={{-10,-10},{10,10}})));
    Pipes.pipe_static pipe_static4(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
      annotation (Placement(transformation(origin={-40,-70},
extent={{-10,-10},{10,10}})));
    Pipes.pipe_static pipe_static5(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
      annotation (Placement(transformation(origin={44,-50},
extent={{-10,-10},{10,10}})));
    Modelica.Fluid.Sources.MassFlowSource_T boundary3(nPorts=1, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, m_flow=20) 
      annotation (Placement(transformation(origin={-86,-70},
extent={{-10,-10},{10,10}})));
    Modelica.Fluid.Sources.Boundary_ph boundary5(nPorts=1, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, p=1e5) 
      annotation (Placement(transformation(origin={90,-50},
extent={{10,-10},{-10,10}})));
    Pipes.pipe_static pipe_static6(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
      annotation (Placement(transformation(origin={44,-96},
extent={{-10,-10},{10,10}})));
    Modelica.Fluid.Sources.Boundary_ph boundary4(nPorts=1, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, p=1e5) 
      annotation (Placement(transformation(origin={90,-96},
extent={{10,-10},{-10,10}})));
    MixingVolume volume2(redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, nPorts_a=2, nPorts_b=2, V=1) 
      annotation (Placement(transformation(origin={-6,-162},
extent={{-10,-10},{10,10}})));
    Pipes.pipe_static pipe_static7(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
      annotation (Placement(transformation(origin={-44,-146},
extent={{-10,-10},{10,10}})));
    Pipes.pipe_static pipe_static9(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
      annotation (Placement(transformation(origin={-44,-176},
extent={{-10,-10},{10,10}})));
    Modelica.Fluid.Sources.MassFlowSource_T boundary6(nPorts=1, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, m_flow=10) 
      annotation (Placement(transformation(origin={-90,-146},
extent={{-10,-10},{10,10}})));
    Modelica.Fluid.Sources.MassFlowSource_T boundary7(nPorts=1, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, m_flow=10) 
      annotation (Placement(transformation(origin={-90,-176.0181},
extent={{-10,-10},{10,10}})));
    Pipes.pipe_static pipe_static8(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
      annotation (Placement(transformation(origin={54,-147},
extent={{-10,-10},{10,10}})));
    Modelica.Fluid.Sources.Boundary_ph boundary8(nPorts=1, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, p=1e5) 
      annotation (Placement(transformation(origin={100,-147},
extent={{10,-10},{-10,10}})));
    Pipes.pipe_static pipe_static10(N=5, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium) 
      annotation (Placement(transformation(origin={54,-193},
extent={{-10,-10},{10,10}})));
    Modelica.Fluid.Sources.Boundary_ph boundary9(nPorts=1, redeclare package Medium = SFR_Striling.Media.Sodium.ConstantPropertyLiquidSodium, p=1e5) 
