...
model CounterFlowPair
  "逆流配对器：交换两侧温度/热流向量顺序（移植自 TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.CounterFlow，纯 MSL 端口）注：Sysplorer 简单类名全局注册，与 TRANSFORM 同名类冲突，故类名取 CounterFlowPair"
