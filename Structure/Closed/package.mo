...
rotation=90)));
    SFR.Stirling.StirlingEngine.StirlingEngine_simplified stirlingEngine 
      annotation (Placement(transformation(origin={301,12.009},
...
extent={{10,-10},{-10,10}})));
    ...
    color={0,127,255}));
    connect(hE1_1.tube_out, stirlingEngine.hot) 
    annotation(Line(origin={156,27},
points={{-27.4962,-4.791},{-27.4962,16.9246},{104,16.9246}},
color={0,127,255}));
    connect(stirlingEngine.cold, pump2.port_a) 
    annotation(Line(origin={206,-20},
points={{54,0.09341},{0,0.09341}},
color={0,127,255}));
